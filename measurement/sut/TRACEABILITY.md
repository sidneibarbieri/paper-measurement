...
| RQ3-J5 | Analysis: profile ablation summary | unique(sw)=90.7%, unique(sw+cve)=90.7%, unique(sw+platform)=90.7%, unique(sw+cve+platform)=90.7%, unique(sw+family)=90.7% | `sut_profile_unique_software_percentage, sut_profile_unique_software_cve_percentage, sut_profile_unique_software_platform_percentage, sut_profile_unique_software_cve_platform_percentage, sut_profile_unique_software_family_only_percentage` | `results/todo_values.json`, `results/audit/profile_ablation_summary.csv` |
